...
function restaurant_recipe_scripts() {
    ...
    /*theme function js*/
    wp_enqueue_script('function', get_template_directory_uri() . '/assets/js/function.js', array('jquery'), '1.0.0', 1);

    /*isotope*/
    wp_enqueue_script('isotope', get_template_directory_uri() . '/assets/library/isotop/isotope.pkgd.min.js', array('jquery'), '1.0.0', 1);
